...
export const VariableInjector: React.FC<VariableInjectorProps> = ({ content, onVariablesFilled, resetTrigger, onComplete }) => {
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      {variables.map((v, index) => (
        <div key={v} className="flex flex-col gap-1 group">
           <div className="flex justify-between items-baseline">
                ...
                {index === 0 && <span className="text-[9px] text-carbon-400">Press Enter to finish</span>}
           </div>
           <input
      ...
      <div className="mt-8 pt-4 border-t border-white/5">
         <p className="text-[10px] uppercase tracking-widest text-carbon-400 mb-2">Preview</p>
